window.onload = function (){
 ...
 function randomNumeros(){
    ...
    let inputUno: HTMLInputElement = <HTMLInputElement>document.getElementById("numeroUno");
    let numeroUno= parseFloat(inputUno.value);

    let inputDos: HTMLInputElement = <HTMLInputElement>document.getElementById("numeroDos");
